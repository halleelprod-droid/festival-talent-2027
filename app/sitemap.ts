...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: "/academy", changeFrequency: "monthly", priority: 0.78 },
    ...
    { path: "/map", changeFrequency: "monthly", priority: 0.84 },
    { path: "/passport", changeFrequency: "monthly", priority: 0.82 },
    ...
    { path: "/hall-of-fame", changeFrequency: "monthly", priority: 0.86 },

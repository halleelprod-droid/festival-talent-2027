# Procédure d'export actualisé des présélections (36 inscriptions)

> Statut au moment de l'audit : **CAS C — aucun nouvel export complet disponible**.
...
## 6. Critères « prêt à importer » (tous requis)
